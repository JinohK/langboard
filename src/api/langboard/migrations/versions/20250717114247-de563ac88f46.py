...
from core.db.ColumnTypes import CSVType
from core.db.ColumnTypes import EnumLikeType
from core.db.ColumnTypes import ModelColumnListType
from core.db.ColumnTypes import ModelColumnType
from core.db.ColumnTypes import SecretStrType
from core.db.ColumnTypes import SnowflakeIDType
from core.db.Models import ChatContentModel
from core.db.Models import EditorContentModel
...
from models.BotSchedule import BotScheduleStatus
from models.InternalBot import InternalBotPlatform
from models.InternalBot import InternalBotPlatformRunningType
...
def upgrade() -> None:
    ...
    op.create_table('global_card_relationship_type',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_table('user_notification_unsubscription',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('user_id', SnowflakeIDType, nullable=False),
    ...
    op.create_index(op.f('ix_user_notification_unsubscription_user_id'), 'user_notification_unsubscription', ['user_id'], unique=False)
    ...
    op.create_table('project_assigned_internal_bot',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index(op.f('ix_project_assigned_internal_bot_internal_bot_id'), 'project_assigned_internal_bot', ['internal_bot_id'], unique=False)
    op.create_index(op.f('ix_project_assigned_internal_bot_project_id'), 'project_assigned_internal_bot', ['project_id'], unique=False)
    op.create_table('project_assigned_user',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('project_id', SnowflakeIDType, nullable=False),
    ...
    op.create_table('user_group_assigned_email',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index(op.f('ix_user_group_assigned_email_group_id'), 'user_group_assigned_email', ['group_id'], unique=False)
    ...
    op.create_table('project_column_bot_log',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index(op.f('ix_project_column_bot_log_bot_log_id'), 'project_column_bot_log', ['bot_log_id'], unique=False)
    op.create_index(op.f('ix_project_column_bot_log_project_column_id'), 'project_column_bot_log', ['project_column_id'], unique=False)
    op.create_table('project_column_bot_schedule',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index(op.f('ix_project_column_bot_schedule_bot_schedule_id'), 'project_column_bot_schedule', ['bot_schedule_id'], unique=False)
    op.create_index(op.f('ix_project_column_bot_schedule_project_column_id'), 'project_column_bot_schedule', ['project_column_id'], unique=False)
    op.create_table('project_column_bot_scope',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('bot_id', SnowflakeIDType, nullable=True),
    ...
    op.create_index(op.f('ix_project_column_bot_scope_project_column_id'), 'project_column_bot_scope', ['project_column_id'], unique=False)
    op.create_table('project_wiki_activity',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('user_id', SnowflakeIDType, nullable=True),
    ...
    op.create_index(op.f('ix_project_wiki_activity_project_wiki_id'), 'project_wiki_activity', ['project_wiki_id'], unique=False)
    op.create_table('project_wiki_assigned_user',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index(op.f('ix_project_wiki_assigned_user_project_assigned_id'), 'project_wiki_assigned_user', ['project_assigned_id'], unique=False)
    op.create_index(op.f('ix_project_wiki_assigned_user_project_wiki_id'), 'project_wiki_assigned_user', ['project_wiki_id'], unique=False)
    op.create_index(op.f('ix_project_wiki_assigned_user_user_id'), 'project_wiki_assigned_user', ['user_id'], unique=False)
    op.create_table('project_wiki_attachment',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_table('project_wiki_metadata',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index(op.f('ix_project_wiki_metadata_project_wiki_id'), 'project_wiki_metadata', ['project_wiki_id'], unique=False)
    op.create_table('card_assigned_project_label',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index(op.f('ix_card_assigned_project_label_card_id'), 'card_assigned_project_label', ['card_id'], unique=False)
    op.create_index(op.f('ix_card_assigned_project_label_project_label_id'), 'card_assigned_project_label', ['project_label_id'], unique=False)
    op.create_table('card_assigned_user',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('project_assigned_id', SnowflakeIDType, nullable=False),
    ...
    op.create_index(op.f('ix_card_assigned_user_project_assigned_id'), 'card_assigned_user', ['project_assigned_id'], unique=False)
    op.create_index(op.f('ix_card_assigned_user_user_id'), 'card_assigned_user', ['user_id'], unique=False)
    op.create_table('card_attachment',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_table('card_bot_schedule',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('bot_schedule_id', SnowflakeIDType, nullable=False),
    ...
    op.create_index(op.f('ix_card_bot_schedule_bot_schedule_id'), 'card_bot_schedule', ['bot_schedule_id'], unique=False)
    op.create_index(op.f('ix_card_bot_schedule_card_id'), 'card_bot_schedule', ['card_id'], unique=False)
    op.create_table('card_bot_scope',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('bot_id', SnowflakeIDType, nullable=True),
    ...
    op.create_table('card_relationship',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index(op.f('ix_card_relationship_relationship_type_id'), 'card_relationship', ['relationship_type_id'], unique=False)
    ...
    op.create_table('card_comment_reaction',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('user_id', SnowflakeIDType, nullable=True),
    ...
    op.create_table('checkitem_timer_record',
    sa.Column('id', SnowflakeIDType, nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index(op.f('ix_checkitem_timer_record_checkitem_id'), 'checkitem_timer_record', ['checkitem_id'], unique=False)
