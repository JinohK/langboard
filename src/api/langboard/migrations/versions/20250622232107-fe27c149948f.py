...
from core.db.ColumnTypes import CSVType, EnumLikeType, ModelColumnType, SecretStrType, SnowflakeIDType
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("target_id", SnowflakeIDType, nullable=False),
        sa.Column("filterable_table", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
        sa.Column("filterable_id", SnowflakeIDType, nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("bot_id", SnowflakeIDType, nullable=False),
        sa.Column("condition", EnumLikeType(BotTriggerCondition), nullable=False),
        sa.Column("is_predefined", sa.Boolean(), nullable=False),
        sa.ForeignKeyConstraint(["bot_id"], ["bot.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(op.f("ix_bot_trigger_bot_id"), "bot_trigger", ["bot_id"], unique=False)
    op.create_table(
        "chat_history",
        sa.Column("id", SnowflakeIDType, nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("bot_id", SnowflakeIDType, nullable=False),
        sa.ForeignKeyConstraint(["bot_id"], ["bot.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["project_assigned_id"], ["project_assigned_bot.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["project_wiki_id"], ["project_wiki.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(op.f("ix_project_wiki_assigned_bot_bot_id"), "project_wiki_assigned_bot", ["bot_id"], unique=False)
    op.create_index(
        op.f("ix_project_wiki_assigned_bot_project_assigned_id"),
        "project_wiki_assigned_bot",
        ["project_assigned_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_project_wiki_assigned_bot_project_wiki_id"),
        "project_wiki_assigned_bot",
        ["project_wiki_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_project_wiki_assigned_bot_project_wiki_id"), table_name="project_wiki_assigned_bot")
    op.drop_index(op.f("ix_project_wiki_assigned_bot_project_assigned_id"), table_name="project_wiki_assigned_bot")
    op.drop_index(op.f("ix_project_wiki_assigned_bot_bot_id"), table_name="project_wiki_assigned_bot")
    op.drop_table("project_wiki_assigned_bot")
    ...
    op.drop_index(op.f("ix_bot_trigger_bot_id"), table_name="bot_trigger")
    op.drop_table("bot_trigger")
