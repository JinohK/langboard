...
import {
    ...
    serializeMdNode,
} from "@/components/Editor/plugins/markdown/serializer/serializeMdNode";
...
export const serializeMdNodes = (
    ...
    const optionsNodes: SerializeMdOptions["nodes"] = merge(defaultSerializeMdNodesOptions, options.nodes);
