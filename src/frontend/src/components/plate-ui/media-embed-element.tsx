...
import { parseTwitterUrl, parseVideoUrl, TMediaEmbedElement } from "@udecode/plate-media";
...
export const MediaEmbedElement = withHOC(ResizableProvider, function MediaEmbedElement(props: PlateElementProps<TMediaEmbedElement>) {
            ...
            <PlateElement className="py-2.5" {...props}>
                <figure className="group relative m-0 w-full cursor-default" contentEditable={false}>
                    ...
                    <Caption style={{ width }} align={align}>
                        <CaptionTextarea placeholder={t("editor.Write a caption...")} />
                    </Caption>
                </figure>
