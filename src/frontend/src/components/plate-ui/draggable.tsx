            ...
            <Gutter>
                <div
                    className={cn(
                        ...
                        "flex h-[1.5em]",
                        isType(editor, element, [HEADING_KEYS.h1, HEADING_KEYS.h2, HEADING_KEYS.h3, HEADING_KEYS.h4, HEADING_KEYS.h5]) && "h-[1.3em]",
                        isInColumn && "h-4",
    ...
    return (
        <div
            ...
            className={cn(
                ...
                STRUCTURAL_TYPES.includes(element.type) ? "main-hover:group-hover/structural:opacity-100" : "main-hover:group-hover:opacity-100",
                ...
                isNodeType([ImagePlugin.key, MediaEmbedPlugin.key]) && "py-0",
