...
import { AudioPlugin, ImagePlugin, MediaEmbedPlugin, PlaceholderPlugin, VideoPlugin } from "@udecode/plate-media/react";
import { TablePlugin } from "@udecode/plate-table/react";

import { type DraggableProps, Draggable } from "./draggable";

export const withDraggable = (Component: FC, options?: WithDraggableOptions<Partial<Omit<DraggableProps, "children" | "editor" | "element">>>) =>
