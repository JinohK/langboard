...
export const AILoadingBar = () => {
    ...
    return (
        <div
            className={cn(
                "absolute bottom-4 left-1/2 z-[999999] flex -translate-x-1/2 items-center gap-3 rounded-md border border-border bg-muted px-3 py-1.5 text-sm text-muted-foreground shadow-md transition-all duration-300"
            )}
        >
