...
const editorContainerVariants = cva(
    "[&:not([data-readonly=true])]:relative w-full cursor-text overflow-y-auto caret-primary selection:bg-brand/25 [&_.slate-selection-area]:border [&_.slate-selection-area]:border-brand/25 [&_.slate-selection-area]:bg-brand/15",
    {
        defaultVariants: {
            variant: "default",
        },
    ...
    ),
    {
        ...
        variants: {
            ...
            variant: {
                ...
                aiChat: "max-h-[min(70vh,320px)] w-full max-w-full overflow-y-auto px-3 py-2 text-sm",
