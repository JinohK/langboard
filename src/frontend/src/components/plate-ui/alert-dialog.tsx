...
>(({ className, ...props }, ref) => (
    <AlertDialogPrimitive.Action ref={ref} className={cn(ButtonVariants({ size: "default" }), className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
    <AlertDialogPrimitive.Cancel
        ref={ref}
        className={cn(ButtonVariants({ size: "default", variant: "outline" }), "mt-2 sm:mt-0", className)}
        {...props}
    />
));
