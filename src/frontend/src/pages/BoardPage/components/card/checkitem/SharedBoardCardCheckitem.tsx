...
const SharedBoardCardCheckitem = forwardRef<HTMLDivElement, TSharedBoardCardCheckitemProps>(
                        ...
                        >
                            ...
                            <Tooltip.Provider delayDuration={400}>
                                <Tooltip.Root open={isTitleOpened} onOpenChange={setIsTitleOpened}>
                                    ...
                                    <Tooltip.Content className={sharedClassNames.morePopover}>{checkitem.title}</Tooltip.Content>
                                </Tooltip.Root>
                            </Tooltip.Provider>
                        </Flex>
                    </Flex>
