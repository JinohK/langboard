...
import { SUB_EMAIL_VERIFY_TOKEN_QUERY_NAME } from "@/controllers/account/useAddNewEmail";
import useVerifyNewEmail from "@/controllers/account/useVerifyNewEmail";
    ...
    useEffect(() => {
        ...
        mutate(
            { verify_token: token },
            {
                onSuccess: () => {
                    updatedUser();
                    Toast.Add.success(t("myAccount.The email verified successfully."));
