...
export const blockSelectionPlugins: readonly ReturnType<typeof BlockSelectionPlugin.configure>[] = [
...
export const blockSelectionReadOnlyPlugin: ReturnType<typeof BlockSelectionPlugin.configure> = BlockSelectionPlugin.configure({
    api: {},
    extendEditor: null,
    handlers: {},
    options: {},
