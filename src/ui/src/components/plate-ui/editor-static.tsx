    ...
    ),
    {
        ...
        variants: {
            ...
            variant: {
                ...
                aiChat: "max-h-[min(70vh,320px)] w-full max-w-[700px] overflow-y-auto px-10 py-2 text-base md:text-sm",
...
export function EditorStatic({ children, className, variant, ...props }: PlateStaticProps & VariantProps<typeof editorVariants>) {
