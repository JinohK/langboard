...
import { PlateElement, PlateElementProps, useEditorMounted, withHOC } from "@udecode/plate/react";
import { useDraggable } from "@udecode/plate-dnd";
import { parseTwitterUrl, parseVideoUrl, TVideoElement } from "@udecode/plate-media";
...
export const MediaVideoElement = withHOC(ResizableProvider, function MediaVideoElement(props: PlateElementProps<TVideoElement>) {
        ...
        <PlateElement className="py-2.5" {...props}>
            <figure className="relative m-0 cursor-default" contentEditable={false}>
                ...
                <Caption style={{ width }} align={align}>
                    <CaptionTextarea readOnly={readOnly} placeholder={t("editor.Write a caption...")} />
                </Caption>
            </figure>
            {props.children}
        </PlateElement>
