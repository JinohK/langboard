...
import { BotLogModel, BotModel, ProjectCard, ProjectColumn } from "@/core/models";
...
import { BotLogListProvider } from "@/components/BotLogList/Provider";
import BotLogListItem from "@/components/BotLogList/Item";
...
function BotLogList({ bot, params, target }: IBotLogListProps) {
    ...
    const logs = BotLogModel.Model.useModels(
