...
import type { AllowedAxis, Axis, Edge, InternalConfig, Spacing } from "@/core/helpers/dnd/auto-scroll/internal-types";
import { canScrollOnEdge } from "@/core/helpers/dnd/auto-scroll/shared/can-scroll-on-edge";
import { edgeAxisLookup, edges } from "@/core/helpers/dnd/auto-scroll/shared/edges";
import { markAndGetEngagement } from "@/core/helpers/dnd/auto-scroll/shared/engagement-history";
import { getScrollChange } from "@/core/helpers/dnd/auto-scroll/shared/get-scroll-change";
import { isAxisAllowed } from "@/core/helpers/dnd/auto-scroll/shared/is-axis-allowed";
import { isWithin } from "@/core/helpers/dnd/auto-scroll/shared/is-within";
import { getHitbox } from "@/core/helpers/dnd/auto-scroll/unsafe-overflow/hitbox";
import {
    type HitboxSpacing,
    type ProvidedHitboxSpacing,
    type UnsafeOverflowAutoScrollArgs,
} from "@/core/helpers/dnd/auto-scroll/unsafe-overflow/types";
...
export function getScrollBy<DragType extends AllDragTypes>({
    ...
    const scrollableEdges: HitboxForEdge[] = inHitboxForEdge.filter(
        (value) => isAxisAllowed(edgeAxisLookup[value.edge], allowedAxis) && canScrollOnEdge[value.edge](entry.element)
    );
