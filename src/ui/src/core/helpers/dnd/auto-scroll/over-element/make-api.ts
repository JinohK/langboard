...
import type { ElementAutoScrollArgs, WindowAutoScrollArgs } from "@/core/helpers/dnd/auto-scroll/internal-types";
import { getScheduler } from "@/core/helpers/dnd/auto-scroll/shared/scheduler";
import { addScrollableAttribute } from "@/core/helpers/dnd/auto-scroll/over-element/data-attributes";
import { tryScroll } from "@/core/helpers/dnd/auto-scroll/over-element/try-scroll";
...
export function makeApi<DragType extends AllDragTypes>({ monitor }: { monitor: (args: MonitorArgs<DragType>) => CleanupFn }) {
    ...
    function autoScroll(args: ElementAutoScrollArgs<DragType>): CleanupFn {
        ...
        const cleanup = combine(addScrollableAttribute(args.element), () => elementRegistry.delete(args.element));
